...
export default function CuttingSelDevice() {
  ...
  return (
    <View style={styles.container}>
       ...
       {Devices.map((device, index) => (
              <TouchableOpacity key={index} style={styles.locationBox} onPress={() => navigation.navigate('CuttingSelLocation', { userId: userId, deviceId: device })}>
